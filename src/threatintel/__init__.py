...
from models import Feed, Feeds, Service, Services, Domains, KnownIPs, SecurityAlert
from config import config
from helpers import log, LogManager
import helpers
...
if __name__ == "__main__":
    ...
    log_manager.setup_logging(log_level=config.app_log_level, file_path=args.log_file)
